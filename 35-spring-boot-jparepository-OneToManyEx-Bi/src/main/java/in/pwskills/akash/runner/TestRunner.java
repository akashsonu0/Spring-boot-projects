...
import in.pwskills.akash.dao.IMobileNumberRepository;
import in.pwskills.akash.dao.IPersonRepository;
...
public class TestRunner implements CommandLineRunner {
	...
	@Autowired
	private IMobileNumberRepository mrepo;
	...
	public void run(String... args) throws Exception {
		...
		// parent obj
		Person per = new Person(11, "Akash", "BR02");
