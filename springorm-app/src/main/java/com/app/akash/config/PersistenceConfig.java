...
public class PersistenceConfig {
	...
	public DataSource dataSource() {
		String location = "D:\\OctBatchMicroservices\\SpringBoot\\springorm-app\\src\\main\\resources\\application.properties";
	...
	public LocalSessionFactoryBean sessionFactory(DataSource dataSource) {
		...
		sessionFactory.setPackagesToScan("com.app.akash.beans");
